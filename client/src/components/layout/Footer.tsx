...
export function Footer() {
  return (
    <footer className="bg-white text-gray-700 pt-16 pb-8 border-t border-white">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <h4 className="text-lg font-display font-bold text-primary mb-6 uppercase tracking-wide">Enlaces</h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={link.label}>
                  <Link href={link.href} className="flex items-center gap-2 hover:text-accent transition-colors group text-gray-700">
          ...
          <div>
            <h4 className="text-lg font-display font-bold text-primary mb-6 uppercase tracking-wide">Contáctenos</h4>
